...
animate={secondCircleComplete ? 'animate' : 'initial'}
 ...
 style={descriptionStyle}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, hic ullam? Molestias fugiat neque asperiores sint reprehenderit provident officiis amet?</p>
        </div>
    )
}
