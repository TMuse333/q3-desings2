...
animate={secondCircleComplete ? 'animate' : 'initial'}
 ...
 <p className="text-left mt-3 pl-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, hic ullam? Molestias fugiat neque asperiores sint reprehenderit provident officiis amet?</p>
        </div>
    )
}
