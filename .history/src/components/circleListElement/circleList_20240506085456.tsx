...
animate={secondCircleComplete ? 'animate' : 'initial'}
 className="text-white text-2xl   mt-5">{title}</motion.h1>

<p className={`text-left mt-3 pl-3 pr-3 bg-blue-600 transition-height ease-in duration-300 bg-blue-800 ${descriptionClicked ? 'h-[220px] w-[165px] overflow-scroll pt-5' : 'h-0  w-0 overflow-hidden pt-0'}`}>
  {description}
</p>
</section>
