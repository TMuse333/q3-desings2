...
<p className={`text-left mt-3 pl-3 pr-3 bg-blue-600 transition-height ease-in duration-300 bg-blue-800 ${descriptionClicked ? 'h-[220px] w-[175px] overflow-scroll pt-5' : 'h-0 overflow-hidden pt-0'}`}>
  {description}
</p>
</section>
