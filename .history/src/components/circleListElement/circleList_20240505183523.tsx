...
const CircleListElement: React.FC<CircleProps> = ({image,title, description}) => {
    ...
    return (
        ...
        sm:flex-row w-3/5 sm:w-3/4 
       border-solid border-blue sm:justify-stretch">
<AppearingCircle
image={image}
/>
<section>
...
<p className={`text-left mt-3 pl-3 pr-3 bg-blue- transition-height ease-in duration-300 bg-blue-800 ${descriptionClicked ? 'h-[220px] overflow-scroll pt-5' : 'h-0 overflow-hidden pt-0'}`}>
  {description}
</p>
</section>
