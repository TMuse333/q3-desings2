...
<p className={`text-left mt-3 pl-3 pr-3 transition-height ease-in duration-300 bg-blue-300 ${descriptionClicked ? 'h-[220px] overflow-scroll' : 'h-0 overflow-hidden '}`}>
