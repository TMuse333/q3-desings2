...
const CircleListElement: React.FC<CircleProps> = ({image,title, description}) => {
    ...
    return (
        ...
        md:flex-row w-screen  md:w-3/4 align-center mb-10 md:mt-3 bg-[#011f29]
   ">
<AppearingCircle
image={image}
/>
<section className="relative flex flex-col bg-[#011f29]
...
animate={secondCircleComplete ? 'animate' : 'initial'}
 className="text-white text-2xl md:w-[100px]  ml-auto mr-auto mt-5 bg-[#011f29]">{title}
 </motion.h1>
...
const CircleList: React.FC = () => {
 ...
 <section className="relative 
         ...
         bg-gradient-to-b from-[#043747] via-[#032029] to-transparent">
