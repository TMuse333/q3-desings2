...
<p className={`rounded-lg text-left mt-3 pl-3 pr-3 bg-blue-600 transition-height ease-in duration-300 bg-blue-800 ${descriptionClicked ? ' h-[220px] w-[125px] overflow-scroll pt-5 border-blue-200' : 'h-0 w-[125px]  overflow-hidden pt-0'}`}>
  {description}
</p>
</section>
