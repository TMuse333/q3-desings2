  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="max-w-3xl bg-gradient-to-br from-white to-gray-400 bg-clip-text text-left text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
