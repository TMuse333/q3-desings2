    ...
    return (
      ...
      ${!subMenuClicked ? 'translate-x-full' : 'translate-x-0'}`}>
        <div className="relative h-full w-full z-70">
            ...
            <ul
                        className={`text-left m5-5 fixed right-[5%] top-[70px] overflow-hidden transition-[height] flex flex-col items-start justify-center rounded-lg w-[140px] lg:bg-transparent lg:w-auto lg:relative lg:overflow-auto lg:top-auto lg:right-auto lg:flex-row `}
                    >
