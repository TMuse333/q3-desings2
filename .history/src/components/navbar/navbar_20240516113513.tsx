...
<>
            ...
            {links.map((link,index) => (
                <div key={index}
                 className="w-[100px] bg-q-blue relative
                 text-white pr-3 pl-3 border border-b-0 border-l-0 border-r-0">
                    <h3>{link.name}</h3>
                    <ul className="absolute text-center bg-q-blue border border-b-0 border-l-0 border-r-0
                   pt-5 pl-3 pr-3 left-[50%] -translate-x-1/2 w-[100px] ">
