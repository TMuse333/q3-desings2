...
hasDescription}) =>{
    ...
    function handleNextClick(){
        ...
        useEffect(()=> {
            ...
            console.log('current centered image',ce)
        },[leftEdgeCase,shift,])
...
sm:h-[50vw]
   ...
   ${updatedImages[index].transformValue === 0 || updatedImages[index].transformValue === 200 ||
    updatedImages[index].transformValue === -100? 'transition-transform duration-500' : ''}
