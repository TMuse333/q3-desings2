...
sm:h-[50vw]
   ...
   key={index}
   style={{
    transform: `translateX(${image.imageIndex === images.length - 1 ? (leftEdgeShift * 100) + (shift * 100) + (100 * image.imageIndex)
