...
sm:h-[50vw]
   ...
   ${(updatedImages[index].transformValue === 0) && !( updatedImages[index].transformValue 
    !== -200 || image.imageIndex === 1 && updatedImages[index].transformValue!== 100 ||
     image.imageIndex === 2 && updatedImages[index].transformValue
    !== 100 )  
