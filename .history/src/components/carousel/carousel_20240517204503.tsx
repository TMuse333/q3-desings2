...
sm:h-[50vw]
   ...
   ${(image.imageIndex === currentImage) || (leftClicked && image.imageIndex === currentImage +1 && !(image.imageIndex === images.length -1))  ||
  (leftClicked && currentImage === 0 && image.imageIndex === images.length -1)  && image.imageIndex !==2? 'transition-transform duration-500' : ''}
