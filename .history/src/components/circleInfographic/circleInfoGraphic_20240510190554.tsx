...
const CircleElement: React.FC<CircleProps> = ({image}) => {
    ...
    return (
        <section className="mt-5 mb-5 sm:w-[30vw] sm:h-[30vw]
        rounded-full bg-[#232a91]
        h-[95vw] w-[95vw] border border-q-blue
        flex flex-col  shadow-xl shadow-indigo-500/60">
            <div className="mt-4">
            <img className="w-[35vw] h-[35vw]
...
export const CircleInfoGraphic = () => {
    ...
    return (
        ...
        sm:justify-around
        sm:flex-row w-screen max-w-[1200px]  max-w-[1200px] 
        bg-blue-800
        ml-auto mr-auto">
            <CircleElement
            image={ball}/>
