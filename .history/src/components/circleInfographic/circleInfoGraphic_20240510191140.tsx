...
export const CircleInfoGraphic = () => {
    ...
    return (
        <section className="flex justify-center flex-col items-center sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 w-screen max-w-[1200px] bg-blue-800 ml-auto mr-auto">
            <CircleElement
            image={ball}/>
             <CircleElement
            image={ball}/>
