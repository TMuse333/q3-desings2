...
const Booking: React.FC = () => {
    ...
    <>
      <div className='w-screen flex justify-center items-center absolute top-0 left-0'>
        <div className='text-center ml-auto'>
          ...
          ml-auto mr-auto'
          />
          <h2 className='text-white text-2xl mt-5'>You have made an excellent choice</h2>
          <p className="">Let's get in contact so we can work together</p>
  ...
  index === inputFields.length - 1 ? (
    ...
    />
        ...
        <p className='pl-5 pr-5'>The laws of physics state that for every action, there
