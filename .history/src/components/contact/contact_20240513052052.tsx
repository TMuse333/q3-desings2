                  ...
                  <form onSubmit={sendEmail} ref={form}>
                    <div className="info-box-container">
                      <input className='border
                       border-blue-400 bg-black rounded-xl
                       text-white'
                      ...
                      <input className='border
                       border-blue-400 bg-black rounded-xl
                       text-white'
                      type="text" placeholder="Company name (if applicable)" name="company_Name" />
                      <input className='border
                       border-blue-400 bg-black rounded-xl
                       text-white'
                      ...
                      <input className='border
                       border-blue-400 bg-black rounded-xl
                       text-white'
                      type="text" placeholder="Project details" name="project_Details" />
