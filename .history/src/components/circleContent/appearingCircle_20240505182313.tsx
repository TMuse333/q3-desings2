...
const AppearingCircle: React.FC<CircleProps> = ({image}) => {
    ...
    const circleOriginX = isMobile ? canvasSize.width / 2 : canvasSize.width /2
    const circleOriginY = isMobile ? canvasSize.height / 2 : canvasSize.height /2
    ...
    useEffect(() => {
        ...
        const padding = isMobile ? 65 : 110; // Adjust the padding as needed
    ...
    return (
        <>
            <div ref={componentRef} className='relative mr-auto ml-auto bg-blue-200 sm:w-3/5'>
                <motion.img 
