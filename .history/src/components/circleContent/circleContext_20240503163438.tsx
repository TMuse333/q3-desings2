...
const CircleContent: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            c.arc(canvasSize.width /2, canvasSize.height / 2, 100, 0,  (fraction * Math.PI) *2 ,false );
            c.lineWidth = 4; // Set border width
            c.strokeStyle = 'red'
            c.stroke();
            ...
            c.beginPath();
            c.moveTo(canvasSize.width / 2, (canvasSize.height / 2) + 100);
            c.lineTo(canvasSize.width + 10, (canvasSize.height / 2) + 100);
