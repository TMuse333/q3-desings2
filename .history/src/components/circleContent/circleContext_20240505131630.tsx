...
const CircleContent: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if(secondCircleComplete){
            ...
            c.lineTo(canvasSize.width / 4 +100, (canvasSize.height / 5) + 20 )
            c.stroke()

            c.beginPath()
            c.moveTo(canvasSize.width / 4 +100, (canvasSize.height / 5) + 20)
            c.lineTo(canvasSize.width / 4 +200, (canvasSize.height / 5) + 50 )
            c.stroke()
