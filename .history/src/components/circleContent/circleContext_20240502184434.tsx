...
const CircleContent: React.FC = () => {
    ...
    const [circleProgress, setCircleProgress] = useState<number>(1)
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            c.arc(canvasSize.width * 2/3, canvasSize.height / 2, 75, 0,  ( circleProgress*Math.PI)/3);
            c.lineWidth = 4; // Set border width
            c.strokeStyle = 'red'
            c.stroke();
        ...
        // Start animation
        animate();
    }, [canvasSize,circleRadius,circleProgress]);
    ...
    useEffect(() => {
        const intervalId = setInterval(() => {
            ...
            else if(circleProgress < 6){
                setCircleProgress(prev=>prev+1)       
            }
