...
const AppearingCircle: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const calculateCanvasSize = () => {
            ...
            const requiredWidth = Math.max(circleOriginX + secondCircleRadius, circleOriginX + circleRadius);
            const requiredHeight = Math.max(circleOriginY + secondCircleRadius, circleOriginY + circleRadius);
    ...
    return (
        <>
            ...
            <canvas className='relative ml-auto mr-auto bg-red-200' ref={canvasRef}></canvas>
