...
c.quadraticCurveTo(
    (canvasSize.width / 4 + 80),                   // Control point X-coordinate
    ((canvasSize.height / 5) + 90),                // Control point Y-coordinate (adjust this to control the curvature)
    (canvasSize.width / 4 + 270),                  // End point X-coordinate
    ((canvasSize.height / 5) + 50)                 // End point Y-coordinate
);
c.stroke();
