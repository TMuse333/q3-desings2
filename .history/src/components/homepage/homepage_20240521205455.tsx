...
const Homepage: React.FC = () => {
   ...
   const images = [
    ...
    ,
    {
        ...
        description:'Experience our interactive user interfaces, game tracking and custom made elements all in our Quantum Card game, demonstrating the ability to make highly interactive and complex complications'
        },
        {
            url:lambo,
            imageIndex:3,
