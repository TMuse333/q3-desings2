...
const Content: React.FC<contentProps> = ({image, customText, description}) => {
    ...
    return (
        ...
        md:flex-row relative max-w-[1200px] mr-auto ml-auto'>
            ...
            {description || 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate rem distinctio veniam doloribus placeat voluptatibus dolores deleniti consequuntur harum \n\nasperiores?'}
            <br/>
