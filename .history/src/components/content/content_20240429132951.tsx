...
const Content: React.FC<contentProps> = ({image, customText}) => {
    ...
    return (
        ...
        md:flex-row relative'>
            ...
            ) : <p className='mt'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero error laudantium, sapiente natus soluta dolor tempora laborum dolores dolorum nisi!</p>}
        </article>
    )
