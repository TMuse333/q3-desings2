    ...
    >
      ...
      {customText ? (
        ...
        <div>
          ...
          <motion.p className="mt-6 pl-5 text-left sm:pl-12 whitespace-pre-line">
            {description ||
            ...
            < </motion.p>p className="mt-6 text-left pl-5 sm:pl-12">
              {description ||
            ...
            <button className="mt-4 -translate-x-2">slat</button>
