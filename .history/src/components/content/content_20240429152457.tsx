...
const Content: React.FC<contentProps> = ({image, customText, description,reverse}) => {
    ...
    return (
        <article className={`flex flex-col justify-center align-center bg-blue-200
       relative mr-auto sm:max-w-[668px] ml-auto  md:justify-around
       md:w-[90vw] md:max-w[1200px]
        ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>

            <img
            className='w-[90vw] h-[55vw] object-cover 
             ml-auto mr-auto max-h-[567px]' src={image}/>
            {customText ? (
                <>
