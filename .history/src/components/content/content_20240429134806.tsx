...
const Content: React.FC<contentProps> = ({image, customText, description}) => {
    ...
    return (
        ...
        md:flex-row relative max-w-[1200px] mr-auto ml-auto'>
            ...
            ) : <p className='mt-6 pl-5 text-left sm:pl-12 whitespace-pre'>
            {description || 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate rem distinctio veniam\n doloribus placeat voluptatibus dolores deleniti consequuntur harum asperiores?'}
            <br/>
