...
,mainTitle,floatingImage}) => {
    ...
    const imageVariants: Variants = {
        initial: {
            ...
            y: floatingImage ? 20 : 0, // Set initial y position with or without oscillating movement
        },
        animate: {
            x: 0,
            y: floatingImage ? [-20, 20] : 0, // Oscillating movement if floatingImage is true
            transition: {
                x: {
                    duration: 1,
                    ease: 'easeInOut',
                ...
                y: {
                    duration: 0.5,
                    yoyo: Infinity, // Oscillate infinitely between -20 and 20
                    ease: 'linear',
                },
            },
        },
