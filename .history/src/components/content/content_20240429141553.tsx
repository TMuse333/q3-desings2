...
const Content: React.FC<contentProps> = ({image, customText, description,reverse}) => {
    ...
    return (
        <article className={`flex flex-col justify-center align-center   return (
            <article className={`flex flex-col justify-center align-center
           relative max-w-[1200px] mr-auto ml-auto md:w-[90vw] ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
    ...
    export default Content bg-red-500
       relative max-w-[1200px] mr-auto ml-auto md:w-[95vw] ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
