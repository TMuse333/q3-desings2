...
const AlternatingText: React.FC = () => {
    ...
    return (
        <section className="alternating-text-container relative mb-4 h-[20vh] bg-blue-700">
            <h1 className='mt-5 text-white text-4xl mb-4 '>Your website is...</h1>
            {/* Display the typed text */}
            <h2 className="typed-text text-white  text-2xl"></h2>
        </section>
    );
};
