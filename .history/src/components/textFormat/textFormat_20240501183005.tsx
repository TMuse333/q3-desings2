...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated,  }) => {
  ...
  return (
    ...
    >
      ...
      md:w-[50vw] md:max-w-[350px]">Having a well done website is
      <span className="font-extra-bold"> one of the smartest things you can do </span>
      for your business. Your website is one of the most important parts
      of your b
      </motion.p>
