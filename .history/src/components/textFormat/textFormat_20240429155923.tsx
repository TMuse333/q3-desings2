...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated, reverse }) => {
  ...
  return (
    <motion.article
      ref={componentRef}
      className="w-[90vw] pl-6 pr-4 relative mt-5
      sm:max-w[668px] sm:pl-8
      sm:mt-8  
       md:pl-14
      md:max-w-[450px] "   
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <motion.p className="text-lg w-screen pr-2 pl-0  text-left w-[90vw] sm:bg-blue-200
      sm:max-w-[650px]
    
      md:w-[50vw] md:max-w-[350px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, voluptatem! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, excepturi.
      </motion.p>
