...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated }) => {
  ...
  return (
    <motion.article
      ref={componentRef}
      className="w-screen md:w-4/5 relative  bg-blue-300 "
      initial={{ opacity: 0 }}
    ...
    >
      ...
      md:w-[50vw] md:text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, voluptatem! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, excepturi.
      </motion.p>
      <motion.ul className="text-left md:text-center pl-8 pt-5 list-disc">
        {points.map((point, index) => (
          <motion.li className="md:text-center"
           key={index} variants={pointVariants(index)} initial="initial" animate={isVisible ? "animate" : "initial"}>
            {point}
          </motion.li>
        ))}
         <motion.button
