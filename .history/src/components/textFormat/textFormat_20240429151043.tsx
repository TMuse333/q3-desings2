...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated, reverse }) => {
  ...
  return (
    <motion.article
      ref={componentRef}
      className="w-screen sm:w-screen md:w-4/5 relative md:max-w-[450px]  sm:mr-auto pl-5 sm:mt-8"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      md:w-[50vw] max-w-[450px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, voluptatem! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, excepturi.
      </motion.p>
