...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated }) => {
  ...
  return (
    ...
    >
      <motion.h1 className="text-2xl pb-5 text-left ml-4 font-weight-500">Lorem ipsum dolor sit.</motion.h1>
      <motion.p className="text-lg w-screen pr-2 pl-4 text-left
