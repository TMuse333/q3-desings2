...
const TextFormat: React.FC = () => {
  ...
  return (
    <article className="w-screen flex flex-col justify-center align-center 
    absolute top-0 left-0">
      <h1 className="text-2xl pb-5">Lorem ipsum dolor sit.</h1>
      <p className="text-lg w-screen pr-2 pl-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, voluptatem!</p>
      <ul>
